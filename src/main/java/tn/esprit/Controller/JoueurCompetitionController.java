...
public class JoueurCompetitionController {
    ...
    private void handleOpenJoueurs() {
        // Already on the player competition selector.
    }
    ...
    private Button createCompetitionCard(String competitionCode) {
        ...
        Image image = EquipeUiSupport.loadResourceImage(JoueurCompetitionController.class, FootballDataCompetitions.logoResourceOf(competitionCode));
        boolean hasImage = image != null;
        imageView.setImage(image);
        imageView.setManaged(hasImage);
        imageView.setVisible(hasImage);

        Label fallbackLabel = new Label(EquipeUiSupport.buildInitials(competitionLabel, "J"));
    ...
    private void openCompetition(Button source, String competitionCode) {
        ...
        SceneNavigator.switchScene(
                ...
                competitionLabel + " | Equipes des joueurs",
                controller -> {
                    if (controller instanceof JoueurTeamController joueurTeamController) {
                        joueurTeamController.setCompetitionFilter(competitionCode);
                    }
                }
        );
    }
