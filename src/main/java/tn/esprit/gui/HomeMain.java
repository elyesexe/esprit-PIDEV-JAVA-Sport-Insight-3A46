...
public class HomeMain extends Application {
    ...
    public void start(Stage stage) {
        ...
        User rememberedUser = RememberMeService.restore();
        if (rememberedUser != null) {
            AuthSession.login(rememberedUser);
            RememberMeService.remember(rememberedUser);
            SceneNavigator.setScene(stage, "/tn/esprit/views/home-view.fxml", "/tn/esprit/styles/home-theme.css", "Sport Insight | Accueil");
        } else {
            AuthSession.logout();
